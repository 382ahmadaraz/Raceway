...
const Header = () => {
  return (
    ...
    >
      <div className="arw-container md:flex md:items-center md:justify-between">
        <div className="md:w-5/6 md:flex md:items-center md:gap-x-4 xl:gap-x-6">
          ...
          <div className="flex flex-col items-center py-1 md:py-0 md:items-start">
            ...
            <p className="uppercase text-3xl sm:text-4xl lg:text-5xl italic font-extrabold tracking-[1.44px] leading-7 text-center text-[#fff]">
              Round 1
            </p>
            <p className="uppercase text-sm italic font-extrabold text-center leading-6 md:text-start md:text-base lg:text-lg text-white">
